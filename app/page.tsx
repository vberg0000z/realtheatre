...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-b from-red-950 via-red-900 to-black">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-yellow-200 rounded-full blur-[200px] opacity-30 animate-pulse" />
      
      {/* Giant pulsating comedy/tragedy masks behind everything */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[300px] md:text-[400px] lg:text-[600px] opacity-10 animate-pulse">
        <span className="drop-shadow-[0_0_50px_rgba(255,215,0,0.5)]">🎭</span>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center px-4 pt-20">
          <div className="text-center">
            ...
            <h1 className="relative mb-8">
              <span 
                className="text-5xl md:text-7xl lg:text-8xl font-black tracking-wider text-white animate-pulse"
                style={{
                  textShadow: '0 0 10px #fff, 0 0 20px #fff, 0 0 30px #ff0, 0 0 40px #ff0, 0 0 50px #ff0, 0 0 60px #ff0, 0 0 70px #ff0'
                }}>
                REALTHEATRE.ART
              </span>
              ...
              <div className="absolute -top-4 -right-4 w-3 h-3 bg-yellow-300 rounded-full animate-pulse shadow-lg shadow-yellow-400/50" />
              <div className="absolute -bottom-4 -left-4 w-3 h-3 bg-yellow-300 rounded-full animate-pulse shadow-lg shadow-yellow-400/50" />
              <div className="absolute -bottom-4 -right-4 w-3 h-3 bg-yellow-300 rounded-full animate-pulse shadow-lg shadow-yellow-400/50" />
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-12 max-w-4xl mx-auto">
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-pink-600 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-red-600 to-orange-600 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
              ...
              <div className="group relative">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-600 to-green-600 rounded-full blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
            ...
            <div className="inline-block transform hover:rotate-3 transition-transform">
              <button className="relative bg-gradient-to-br from-yellow-100 to-yellow-300 text-black px-12 py-6 font-bold text-xl rounded-lg shadow-2xl hover:shadow-yellow-400/50 transition-all">
                <span 
                  ...
                  style={{background: 'repeating-linear-gradient(90deg, transparent 0, transparent 4px, rgba(0,0,0,0.1) 4px, rgba(0,0,0,0.1) 8px)'}}
                />
